        ...
        <div className="wrapper">
            <div className="body">
                <a 
                    href={myTwitterLink} 
                    id="myTwitterLink" 
                    title="My twitter link">Twitter Link
                </a>
                <a 
                    href={zuriTraining} 
                    id="btn__zuri" 
                    title="Zuri Training Team">Zuri Team
                </a>
                <a 
                    href={books} 
                    id="books" 
                    title="This is where you find books about design and coding">Zuri Books
                </a>
                <a 
                    href={book_python} 
                    id="book__python" 
                    title="Python featured Books">Python Books
                </a>
                <a 
                    href={pitch} 
                    id="pitch" 
                    title="This is where you pitch a service for doing background checks on coders">Background Check for Coders
                </a>
                <a 
                    href={design_rules} 
                    id="book__design" 
                    title="This is where you pitch the free design book offered by Zuri">Design Books
                </a>

                <Link 
                    to="/contact"
                    id="contact" 
                    title="Reach out to me">Contact Me
                </Link>
            </div>
